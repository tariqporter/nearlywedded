module.exports.getEmail = ({ id, name }) =>
  ...
  <table
    ...
    cellspacing="0"
    align="center"
    style="background:#fff;padding:30px;border:4px rgba(214,228,224,0.5) solid"
  >
    <tbody>
      <tr>
        <td
          ...
          align="center"
          height="30"
          style="font-family:Georgia,Times,'Times New Roman',serif;font-size:26px"
        >
          Tariq &amp; Irina
        </td>
      </tr>
      <tr>
        <td
          ...
          align="center"
          height="30"
          style="font-family:Georgia,Times,'Times New Roman',serif;color:#777"
        >
          ARE GETTING MARRIED!
        </td>
      </tr>
